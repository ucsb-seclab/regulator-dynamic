...
int main(int argc, char* argv[])
{
    ...
    if (args.target == regulator::kByteCode)
    {
        ...
        v8::internal::regexp_exec_cost = 10;
        v8::internal::Handle<v8::internal::Object> o2 = v8::internal::RegExp::Exec(
            i_isolate, regexp, subject, 0, match_info).ToHandleChecked();
        o2->Print(cout);
        cout << "hello" << endl;
        cout << "exec count: " << v8::internal::regexp_exec_cost << endl;
        cout << "exec count addr: " << std::hex << (uintptr_t)(&v8::internal::regexp_exec_cost) << endl;
